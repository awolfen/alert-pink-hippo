    ...
    <>
      <div
        className={`QuestionComponent ${
          percentCorrect <= 0.33 ? "Background0" : ""
        }${0.33 < percentCorrect && percentCorrect < 1 ? "Background1" : ""}${
          percentCorrect === 1 ? "Background2" : ""
        }`}
      >
        ...
        <h1 className="AnswerText">
          The answer is {percentCorrect === 1 ? "correct" : "incorrect"}.
        </h1>
      </div>
    </>
  );
